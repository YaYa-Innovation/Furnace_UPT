...
def field_data():
    ...
    if request.method == 'POST':
        ...
        if shift==("FULL NIGHT"):
            ...
            o='=(B%d-D%d)'% (match_date,match_date-1)
            sheet.cell(column=12, row=match_date, value=o)
            sheet['O1'] = "FULL NIGHT (UPT)"
            q='=(L%d/E%d)'% (match_date,match_date)
            sheet.cell(column=15, row=match_date, value=q)
            ...
            o='=(C%d-B%d)'% (match_date,match_date)
            sheet.cell(column=13, row=match_date, value=o)
            sheet['P1'] = "DAY SHIFT (UPT)"
            q='=(M%d/F%d)'% (match_date,match_date)
            sheet.cell(column=16, row=match_date, value=q)
            ...
            o='=(D%d-C%d)'% (match_date,match_date)
            sheet.cell(column=14, row=match_date, value=o)
